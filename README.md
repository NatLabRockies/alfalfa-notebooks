# PACER Notebooks
The PACER Notebooks repository is a collection of introductory Jupyter notebooks for how to interact with a [PACER](https://github.com/NatLabRockies/alfalfa) instance via the [pacer-client](https://github.com/NatLabRockies/alfalfa-client) Python library.
